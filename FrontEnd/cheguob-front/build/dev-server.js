...
//       app.use(mock.api, proxyMiddleware({target: 'http://10.10.13.12:8080'}));
//     }
//   });
// })(mockDir);

//配置代理接口功能
const apiProxy = proxyMiddleware('/dealer', { target: 'http://10.10.13.12:8080',changeOrigin: true });
app.use('/dealer/*', apiProxy);

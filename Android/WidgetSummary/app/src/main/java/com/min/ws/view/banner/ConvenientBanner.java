package com.min.ws.view.banner;
...
import com.min.ws.R;
import com.min.ws.view.banner.adapter.CBPageAdapter;
import com.min.ws.view.banner.holder.CBViewHolderCreator;
import com.min.ws.view.banner.listener.CBPageChangeListener;
import com.min.ws.view.banner.listener.OnItemClickListener;
import com.min.ws.view.banner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(
                R.layout.banner_viewpager, this, true);

...
//			lineRight = (currentPositionOffset * nextTabRight + (1f - currentPositionOffset) * lineRight);
        ...
        //draw triangle
//        float middle=lineLeft+(lineRight-lineLeft)/2;
//        float top=height - indicatorHeight;
//        float bottom=height;
//        float distance=indicatorHeight;
//        Path path = new Path();
//        path.moveTo(middle-distance/2, bottom);// 此点为多边形的起点
//        path.lineTo(middle, top);
//        path.lineTo(middle+distance/2, bottom);

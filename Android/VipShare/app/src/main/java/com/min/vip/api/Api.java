...
public interface Api {
    ...
    @FormUrlEncoded
    @POST("http://10.10.13.12:8080/dealer/login.json")
    Call<BaseBean> loginCall(@Field("username") String userName, @Field("userpwd") String userPass);
    ...
    Observable<BaseBean<List<OrderRespBean>>> getOrderList(@Field("loantype") String loantype
    ...
    @GET("getVipList")
    Observable<BaseBean<VipListRespBean>> getVipListData();

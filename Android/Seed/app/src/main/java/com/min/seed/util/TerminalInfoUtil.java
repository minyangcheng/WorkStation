...
public class TerminalInfoUtil {
    ...
    public static final String KEY_TERMINAL_INFO = "terminalInfoKey";
    ...
    public TerminalInfo getTerminalInfo() {
        String s = SPUtils.getInstance().getString(KEY_TERMINAL_INFO);
        ...
        if (terminalInfo == null) {
            ...
            SPUtils.getInstance().put(KEY_TERMINAL_INFO, GsonUtil.toJson(terminalInfo));
        }
        return terminalInfo;
    }

...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Test", "mDataManager=" + mDataManager.toString());
        Log.d("Test", "mDataManager_1=" + mDataManager_1.toString());
    }
    ...
    private void loadCharacters() {
        if (DataUtils.isNetworkAvailable(this)) {
            final int[] characterIds = getResources().getIntArray(R.array.characters);
            mSubscriptions.add(mDataManager.getCharacters(characterIds)
                    ...
                    .subscribe(new Subscriber<List<Character>>() {
                        ...
                        public void onNext(List<Character> characters) {
                            Timber.d("this is test debug");
                            Timber.w("this is test warn");
                            Timber.e("this is test error");
                            Timber.tag("this is").d("this is tag");
                            Timber.d(new IllegalArgumentException("参数错误"), "mess=%s", "消息");
                            mProgressBar.setVisibility(View.GONE);
                            mSwipeRefresh.setRefreshing(false);
